...
void	draw_menu(t_data *data)
{
	...
	mlx_string_put(data->mlx_ptr, data->win_ptr, 30, 60, 0xf54242, "iterations up/down 1, 2");
	mlx_string_put(data->mlx_ptr, data->win_ptr, 30, 80, 0xf54242, "reverse zoom 3");
	mlx_string_put(data->mlx_ptr, data->win_ptr, 30, 100, 0xf54242, "swap color 5, 6");
	if (!data->solo_tread)
